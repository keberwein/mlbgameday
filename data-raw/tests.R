...
# 
# 
# Time difference of 2.382407 mins
...
z=make_gids(start = "2016-09-03", end = "2016-10-02", cluster = NULL)

start=Sys.time() ; print(start)
zzz= tidygameday::get_payload(start = "2016-09-03", end = "2016-10-02", cluster = "cl")
end=Sys.time()
runtime = end - start
runtime
