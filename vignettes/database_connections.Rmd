...
Relational databases provide an easy way to work with data that are larger than memory. Gameday data can grow rather large, so the `mlbgameday` package provides techniques for using databases.
